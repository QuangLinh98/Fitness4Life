package fpt.aptech.userservice.service;

import fpt.aptech.userservice.dtos.MailEntity;
...
public class MailResetPass {
    ...
    public void sendMailOTP(MailEntity mailEntity) throws MessagingException, UnsupportedEncodingException {
        ...
        mimeMessageHelper.setFrom(new InternetAddress(sender, "Fitness 4 Life"));
